...
class Config_Action_Request_Schema(Base_Schema):
    ...
    args = Str(many=True, example='-al', description='Single command argument.')
    daemon = Boolean(default=False, example=True, description='Execute the command as daemon.')
...
class Config_Resource_Request_Schema(Base_Schema):
    ...
    id = Str(required=True, example='filebeat-config', description='Id of the resource.')
    path = Str(required=True, example=EXAMPLE_FILENAME, description='File path')
...
class Config_Request_Schema(Base_Schema):
    ...
    actions = Nested(Config_Action_Request_Schema, many=True, unknown='INCLUDE', description='List of actions.')
    parameters = Nested(Config_Parameter_Request_Schema, many=True, unknown='INCLUDE', description='List of parameters.')
    resources = Nested(Config_Resource_Request_Schema, many=True, unknown='INCLUDE', description='List of resources.')
